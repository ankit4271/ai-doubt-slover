...
function Output() {
  return (
    <section class="chatsection">
          <div class="my-chat">Text type by me</div>
          <div class="chat-reply-ai">
            <div class="chat-repply-ai-icon">
              <svg
                width="41"
                height="41"
                viewBox="0 0 41 41"
            ...
            <div class="ai-chat-solution">
              <p>
                Sure, I can help you create HTML and CSS to replicate the
                interface shown in your screenshot. Here's a basic example:
              </p>
              <h3>HTML</h3>
              <div class="ai-code-secion">
                <div class="black-output">
                  <div class="ai-code-screen-header">
                    HTML
                    <div class="ai-copy-code">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
              ...
              <div class="ai-code-secion">
                ...
                <div class="detail-about-solution">
                  This code provides a basic layout similar to the one shown in
                  your screenshot. You can replace logo.png and user-avatar.png
                  with the actual paths to your images. This example assumes you
                  have basic knowledge of HTML and CSS, so feel free to modify
                  it according to your needs.
                </div>

                <div class="end-ai-chat-option">
                  <ul>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
