    ...
    <div class="ai-chat-sidebar">
      ...
      <div class="scrollable-sidebar">
        ...
        <div class="chat-history-wrap">
          <div class="chat-history-heading">Previous 30 Days</div>

          <ul>
            <li>Create a workout plan</li>
            <li>Quiz me on world capitals</li>
            <li>Write a story in my favorite genre</li>
            <li>Make me a personal webpage</li>
          </ul>
        </div>

        {/* <!-- date section 1--> */}
        <div class="chat-history-wrap">
          <div class="chat-history-heading">Today</div>
